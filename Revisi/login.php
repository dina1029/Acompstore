        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="kiri">
                <h5 class="card-title2 text-center pb-0 fs-4">Welcome To</h5>
                <p class="putih text-center small">Login Form</p>

                <img src="assets/img/logon.png" alt="" width="210px" height="250px" class="w-auto">
              </div>

              <div class="kanan card mb-3">

                <!-- <div class="d-flex justify-content-center py-4">
                  <a class="logo align-items-center w-auto">
                    <img src="assets/img/logo.png" alt="">
                    <span class="d-none d-lg-block align-items-center w-auto">NiceAdmin</span>
                  </a>
                </div> -->
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-center">
                    <img src="assets/img/gambar3.png" alt="" width="210px" height="120px" class="w-auto">
                </div>
                <div>
                  <p class="atas card-title text-center">Acompstore</p>
                </div>
